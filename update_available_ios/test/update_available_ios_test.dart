...
void main() {
  test(
    ...
    () async {
      ...
      final plugin = UpdateAvailablePlugin(
        ...
        getIOSPackageVersion: (_, {appStoreRegion}) async => null,
  ...
  test(
    ...
    () async {
      ...
      final plugin = UpdateAvailablePlugin(
        getIOSBundleId: () async => 'fakeId',
        getIOSPackageVersion: (_, {appStoreRegion}) async => Version(1, 0, 0),
  ...
  test(
    ...
    () async {
      ...
      final plugin = UpdateAvailablePlugin(
        getIOSBundleId: () async => 'fakeId',
        getIOSPackageVersion: (_, {appStoreRegion}) async => Version(1, 1, 0),
        getIOSVersion: () async => Version(1, 0, 0),
      );
